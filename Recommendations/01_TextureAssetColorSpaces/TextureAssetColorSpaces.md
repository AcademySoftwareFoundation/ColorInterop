...
An OpenColorIO config file is provided which implements the recommended color spaces. The file is `core-renderer-config.ocio`, available in the same directory as this document on GitHub.

[OCIO Reference Config](./core-renderer-config.ocio)
